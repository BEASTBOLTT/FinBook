...
const Sidebar = () => {
  return (
    <div className='bg-[#0A0A0A] h-full md:w-64 w-20 shrink-0 pt-10 transition-all duration-300'>
      {/* Dashboard */}
      <NavLink to='/' className={({ isActive }) => isActive ? "text-white flex items-center md:justify-start justify-center bg-[#111111] md:p-4 p-3 m-1 border-[#D4AF37] border rounded-2xl font-bold" : "text-[#666B74] flex items-center md:justify-start justify-center font-bold p-2 m-1"} title="Dashboard">
        ...
        <h1 className="pl-2 hidden md:block">DashBoard</h1>
      </NavLink>
      {/* Insights */}
      <NavLink to='/Insights' className={({ isActive }) => isActive ? "text-white flex items-center md:justify-start justify-center bg-[#111111] md:p-4 p-3 m-1 border-[#D4AF37] border rounded-2xl font-bold" : "text-[#666B74] flex items-center md:justify-start justify-center font-bold p-2 m-1"} title="Insights">
        ...
        <h1 className="pl-2 hidden md:block">Insights</h1>
      </NavLink>
      {/* Transactions */}
      <NavLink to='/transactions' className={({ isActive }) => isActive ? "text-white flex items-center md:justify-start justify-center bg-[#111111] md:p-4 p-3 m-1 border-[#D4AF37] border rounded-2xl font-bold" : "text-[#666B74] flex items-center md:justify-start justify-center font-bold p-2 m-1"} title="Transactions">
        ...
        <h1 className="pl-2 hidden md:block">Transactions</h1>
      </NavLink>
    </div>
  )
}
